...
<div>
  <div class="flex justify-between items-center mb-6">
    ...
    <a href="/instances/new" class="px-4 py-2 bg-indigo-600 text-white rounded-lg hover:bg-indigo-700">
      New Instance
    </a>
  </div>
  ...
  {:else if instanceList.length === 0}
    <div class="text-center py-12 bg-white rounded-lg border">
      ...
      <a href="/instances/new" class="text-indigo-600 hover:text-indigo-800">Create your first instance</a>
    </div>
  {:else}
